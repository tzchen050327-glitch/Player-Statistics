    ...
    const DEFAULT_HITTER_PHOTO_URL = './assets/default-hitter.jpg?v=v5.08';
    const DEFAULT_PITCHER_PHOTO_URL = './assets/default-pitcher.jpg?v=v5.08';
