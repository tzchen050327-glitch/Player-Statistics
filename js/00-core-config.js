    ...
    const LEAGUE_STANDINGS_API_URL = 'https://kjndnsztbcpmkhictjkr.supabase.co/functions/v1/league-standings';
    ...
    const DEFAULT_HITTER_PHOTO_URL = './assets/default-hitter.jpg?v=v4.60';
    const DEFAULT_PITCHER_PHOTO_URL = './assets/default-pitcher.jpg?v=v4.60';
