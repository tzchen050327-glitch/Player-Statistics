    ...
    const DEFAULT_HITTER_PHOTO_URL = './assets/default-hitter.jpg?v=v6.63';
    const DEFAULT_PITCHER_PHOTO_URL = './assets/default-pitcher.jpg?v=v6.63';
