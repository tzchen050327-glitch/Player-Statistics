    ...
    const DEFAULT_HITTER_PHOTO_URL = './assets/default-hitter.jpg?v=v6.74';
    const DEFAULT_PITCHER_PHOTO_URL = './assets/default-pitcher.jpg?v=v6.74';
