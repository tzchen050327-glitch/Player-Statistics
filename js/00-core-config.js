    ...
    const DEFAULT_HITTER_PHOTO_URL = './assets/default-hitter.jpg?v=v6.03';
    const DEFAULT_PITCHER_PHOTO_URL = './assets/default-pitcher.jpg?v=v6.03';
    ...
    const els = {
      ...
      milestonePage: document.getElementById('milestonePage'),
      milestonePageContent: document.getElementById('milestonePageContent'),
      homeMilestoneBtn: document.getElementById('homeMilestoneBtn'),
      milestoneBackHomeBtn: document.getElementById('milestoneBackHomeBtn'),
