const CACHE_NAME = 'baseball-player-card-pwa-v506-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.06',
  './dark-theme-overrides.css?v=v5.06',
  './diagnostic-runtime.js?v=v5.06',
  './live-static-update.js?v=v5.06',
  './cpbl-realtime.js?v=v5.06',
  './npb-realtime.js?v=v5.06',
  './postseason-history.css?v=v5.06',
  './js/module-loader.js?v=v5.06',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v5.06',
  './cpbl-cache-router.js?v=v5.06',
  './game-detail-enhancement.css?v=v5.06',
  './report-layout.css?v=v5.06',
  './landscape-state.css?v=v5.06',
  './game-detail-enhancement.js?v=v5.06',
  './report-layout.js?v=v5.06',
  './manifest.webmanifest?v=v5.06',
  './icon-192.png?v=v5.06',
  './icon-512.png?v=v5.06',
  './favicon-32.png?v=v5.06',
  './favicon-16.png?v=v5.06'
];
