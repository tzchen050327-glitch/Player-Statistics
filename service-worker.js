const CACHE_NAME = 'baseball-player-card-pwa-v398-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.98',
  './diagnostic-runtime.js?v=v3.98',
  './live-static-update.js?v=v3.98',
  './cpbl-realtime.js?v=v3.98',
  './npb-realtime.js?v=v3.98',
  './postseason-history.css?v=v3.98',
  './js/module-loader.js?v=v3.98',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.98',
  './cpbl-cache-router.js?v=v3.98',
  './game-detail-enhancement.css?v=v3.98',
  './report-layout.css?v=v3.98',
  './landscape-state.css?v=v3.98',
  './game-detail-enhancement.js?v=v3.98',
  './report-layout.js?v=v3.98',
