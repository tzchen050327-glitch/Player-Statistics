const CACHE_NAME = 'baseball-player-card-pwa-v282-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.82',
  './live-static-update.js?v=v2.82',
  './cpbl-realtime.js?v=v2.82',
  './npb-realtime.js?v=v2.82',
  './postseason-history.css?v=v2.82',
  './app.js?v=v2.82',
  './postseason-history.js?v=v2.82',
  './cpbl-cache-router.js?v=v2.82',
  './game-detail-enhancement.css?v=v2.82',
  './report-layout.css?v=v2.82',
  './landscape-state.css?v=v2.82',
  './game-detail-enhancement.js?v=v2.82',
  './report-layout.js?v=v2.82',
