const CACHE_NAME = 'baseball-player-card-pwa-v303-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.03',
  './live-static-update.js?v=v3.03',
  './cpbl-realtime.js?v=v3.03',
  './npb-realtime.js?v=v3.03',
  './postseason-history.css?v=v3.03',
  './app.js?v=v3.03',
  './postseason-history.js?v=v3.03',
  './cpbl-cache-router.js?v=v3.03',
  './game-detail-enhancement.css?v=v3.03',
  './report-layout.css?v=v3.03',
  './landscape-state.css?v=v3.03',
  './game-detail-enhancement.js?v=v3.03',
  './report-layout.js?v=v3.03',
