const CACHE_NAME = 'baseball-player-card-pwa-v619-auto';
const CACHE_VERSION = 'v6.19';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.19',
  './dark-theme-overrides.css?v=v6.19',
  './diagnostic-runtime.js?v=v6.19',
  './live-static-update.js?v=v6.19',
  './cpbl-realtime.js?v=v6.19',
  './npb-realtime.js?v=v6.19',
  './postseason-history.css?v=v6.19',
  './js/module-loader.js?v=v6.19',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.19',
  './cpbl-cache-router.js?v=v6.19',
  './game-detail-enhancement.css?v=v6.19',
  './report-layout.css?v=v6.19',
  './landscape-state.css?v=v6.19',
  './game-detail-enhancement.js?v=v6.19',
  './report-layout.js?v=v6.19',
  './manifest.webmanifest?v=v6.19',
  './icon-192.png?v=v6.19',
  './icon-512.png?v=v6.19',
  './favicon-32.png?v=v6.19',
  './favicon-16.png?v=v6.19'
];
