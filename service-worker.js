const CACHE_NAME = 'baseball-player-card-pwa-v395-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.95',
  './diagnostic-runtime.js?v=v3.95',
  './live-static-update.js?v=v3.95',
  './cpbl-realtime.js?v=v3.95',
  './npb-realtime.js?v=v3.95',
  './postseason-history.css?v=v3.95',
  './js/module-loader.js?v=v3.95',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.95',
  './cpbl-cache-router.js?v=v3.95',
  './game-detail-enhancement.css?v=v3.95',
  './report-layout.css?v=v3.95',
  './landscape-state.css?v=v3.95',
  './game-detail-enhancement.js?v=v3.95',
  './report-layout.js?v=v3.95',
