const CACHE_NAME = 'baseball-player-card-pwa-v312-auto';
...
const APP_SHELL = [
  ...
  './postseason-history.css?v=v3.12',
  './app.js?v=v3.12',
  './postseason-history.js?v=v3.12',
  './cpbl-cache-router.js?v=v3.12',
  './game-detail-enhancement.css?v=v3.12',
  './report-layout.css?v=v3.12',
  './landscape-state.css?v=v3.12',
  './game-detail-enhancement.js?v=v3.12',
  './report-layout.js?v=v3.12',
