const CACHE_NAME = 'baseball-player-card-pwa-v41-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.1',
  './diagnostic-runtime.js?v=v4.1',
  './live-static-update.js?v=v4.1',
  './cpbl-realtime.js?v=v4.1',
  './npb-realtime.js?v=v4.1',
  './postseason-history.css?v=v4.1',
  './js/module-loader.js?v=v4.1',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.1',
  './cpbl-cache-router.js?v=v4.1',
  './game-detail-enhancement.css?v=v4.1',
  './report-layout.css?v=v4.1',
  './landscape-state.css?v=v4.1',
  './game-detail-enhancement.js?v=v4.1',
  './report-layout.js?v=v4.1',
