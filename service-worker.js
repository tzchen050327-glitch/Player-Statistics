const CACHE_NAME = 'baseball-player-card-pwa-v632-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.32',
  './dark-theme-overrides.css?v=v6.32',
  './diagnostic-runtime.js?v=v6.32',
  './live-static-update.js?v=v6.32',
  './cpbl-realtime.js?v=v6.32',
  './npb-realtime.js?v=v6.32',
  './postseason-history.css?v=v6.32',
  './js/module-loader.js?v=v6.32',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.32',
  './cpbl-cache-router.js?v=v6.32',
  './game-detail-enhancement.css?v=v6.32',
  './report-layout.css?v=v6.32',
  './landscape-state.css?v=v6.32',
  './game-detail-enhancement.js?v=v6.32',
  './report-layout.js?v=v6.32',
  './manifest.webmanifest?v=v6.32',
  './icon-192.png?v=v6.32',
  './icon-512.png?v=v6.32',
  './favicon-32.png?v=v6.32',
  './favicon-16.png?v=v6.32'
];
