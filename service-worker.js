const CACHE_NAME = 'baseball-player-card-pwa-v301-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.01',
  './live-static-update.js?v=v3.01',
  './cpbl-realtime.js?v=v3.01',
  './npb-realtime.js?v=v3.01',
  './postseason-history.css?v=v3.01',
  './app.js?v=v3.01',
  './postseason-history.js?v=v3.01',
  './cpbl-cache-router.js?v=v3.01',
  './game-detail-enhancement.css?v=v3.01',
  './report-layout.css?v=v3.01',
  './landscape-state.css?v=v3.01',
  './game-detail-enhancement.js?v=v3.01',
  './report-layout.js?v=v3.01',
