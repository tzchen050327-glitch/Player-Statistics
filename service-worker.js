const CACHE_NAME = 'baseball-player-card-pwa-v302-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.02',
  './live-static-update.js?v=v3.02',
  './cpbl-realtime.js?v=v3.02',
  './npb-realtime.js?v=v3.02',
  './postseason-history.css?v=v3.02',
  './app.js?v=v3.02',
  './postseason-history.js?v=v3.02',
  './cpbl-cache-router.js?v=v3.02',
  './game-detail-enhancement.css?v=v3.02',
  './report-layout.css?v=v3.02',
  './landscape-state.css?v=v3.02',
  './game-detail-enhancement.js?v=v3.02',
  './report-layout.js?v=v3.02',
