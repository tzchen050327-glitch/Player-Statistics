const CACHE_NAME = 'baseball-player-card-pwa-v639-auto';
const CACHE_VERSION = 'v6.39';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.39',
  './dark-theme-overrides.css?v=v6.39',
  './diagnostic-runtime.js?v=v6.39',
  './live-static-update.js?v=v6.39',
  './cpbl-realtime.js?v=v6.39',
  './npb-realtime.js?v=v6.39',
  './postseason-history.css?v=v6.39',
  './js/module-loader.js?v=v6.39',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.39',
  './cpbl-cache-router.js?v=v6.39',
  './game-detail-enhancement.css?v=v6.39',
  './report-layout.css?v=v6.39',
  './landscape-state.css?v=v6.39',
  './game-detail-enhancement.js?v=v6.39',
  './report-layout.js?v=v6.39',
  './manifest.webmanifest?v=v6.39',
  './icon-192.png?v=v6.39',
  './icon-512.png?v=v6.39',
  './favicon-32.png?v=v6.39',
  './favicon-16.png?v=v6.39'
];
