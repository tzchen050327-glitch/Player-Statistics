const CACHE_NAME = 'baseball-player-card-pwa-v597-auto';
const CACHE_VERSION = 'v5.97';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.97',
  './dark-theme-overrides.css?v=v5.97',
  './diagnostic-runtime.js?v=v5.97',
  './live-static-update.js?v=v5.97',
  './cpbl-realtime.js?v=v5.97',
  './npb-realtime.js?v=v5.97',
  './postseason-history.css?v=v5.97',
  './js/module-loader.js?v=v5.97',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v5.97',
  './cpbl-cache-router.js?v=v5.97',
  './game-detail-enhancement.css?v=v5.97',
  './report-layout.css?v=v5.97',
  './landscape-state.css?v=v5.97',
  './game-detail-enhancement.js?v=v5.97',
  './report-layout.js?v=v5.97',
  './manifest.webmanifest?v=v5.97',
  './icon-192.png?v=v5.97',
  './icon-512.png?v=v5.97',
  './favicon-32.png?v=v5.97',
  './favicon-16.png?v=v5.97'
];
