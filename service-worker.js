const CACHE_NAME = 'baseball-player-card-pwa-v396-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.96',
  './diagnostic-runtime.js?v=v3.96',
  './live-static-update.js?v=v3.96',
  './cpbl-realtime.js?v=v3.96',
  './npb-realtime.js?v=v3.96',
  './postseason-history.css?v=v3.96',
  './js/module-loader.js?v=v3.96',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.96',
  './cpbl-cache-router.js?v=v3.96',
  './game-detail-enhancement.css?v=v3.96',
  './report-layout.css?v=v3.96',
  './landscape-state.css?v=v3.96',
  './game-detail-enhancement.js?v=v3.96',
  './report-layout.js?v=v3.96',
