const CACHE_NAME = 'baseball-player-card-pwa-v392-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.92',
  './diagnostic-runtime.js?v=v3.92',
  './live-static-update.js?v=v3.92',
  './cpbl-realtime.js?v=v3.92',
  './npb-realtime.js?v=v3.92',
  './postseason-history.css?v=v3.92',
  './js/module-loader.js?v=v3.92',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.92',
  './cpbl-cache-router.js?v=v3.92',
  './game-detail-enhancement.css?v=v3.92',
  './report-layout.css?v=v3.92',
  './landscape-state.css?v=v3.92',
  './game-detail-enhancement.js?v=v3.92',
  './report-layout.js?v=v3.92',
