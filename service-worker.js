const CACHE_NAME = 'baseball-player-card-pwa-v284-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.84',
  './live-static-update.js?v=v2.84',
  './cpbl-realtime.js?v=v2.84',
  './npb-realtime.js?v=v2.84',
  './postseason-history.css?v=v2.84',
  './app.js?v=v2.84',
  './postseason-history.js?v=v2.84',
  './cpbl-cache-router.js?v=v2.84',
  './game-detail-enhancement.css?v=v2.84',
  './report-layout.css?v=v2.84',
  './landscape-state.css?v=v2.84',
  './game-detail-enhancement.js?v=v2.84',
  './report-layout.js?v=v2.84',
