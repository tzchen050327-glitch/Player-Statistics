const CACHE_NAME = 'baseball-player-card-pwa-v647-auto';
const CACHE_VERSION = 'v6.47';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.47',
  './dark-theme-overrides.css?v=v6.47',
  './diagnostic-runtime.js?v=v6.47',
  './live-static-update.js?v=v6.47',
  './cpbl-realtime.js?v=v6.47',
  './npb-realtime.js?v=v6.47',
  './postseason-history.css?v=v6.47',
  './js/module-loader.js?v=v6.47',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.47',
  './cpbl-cache-router.js?v=v6.47',
  './game-detail-enhancement.css?v=v6.47',
  './report-layout.css?v=v6.47',
  './landscape-state.css?v=v6.47',
  './game-detail-enhancement.js?v=v6.47',
  './report-layout.js?v=v6.47',
  './manifest.webmanifest?v=v6.47',
  './icon-192.png?v=v6.47',
  './icon-512.png?v=v6.47',
  './favicon-32.png?v=v6.47',
  './favicon-16.png?v=v6.47'
];
