const CACHE_NAME = 'baseball-player-card-pwa-v388-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.88',
  './diagnostic-runtime.js?v=v3.88',
  './live-static-update.js?v=v3.88',
  './cpbl-realtime.js?v=v3.88',
  './npb-realtime.js?v=v3.88',
  './postseason-history.css?v=v3.88',
  './js/module-loader.js?v=v3.88',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.88',
  './cpbl-cache-router.js?v=v3.88',
  './game-detail-enhancement.css?v=v3.88',
  './report-layout.css?v=v3.88',
  './landscape-state.css?v=v3.88',
  './game-detail-enhancement.js?v=v3.88',
  './report-layout.js?v=v3.88',
