...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.86',
  './diagnostic-runtime.js?v=v3.86',
  './live-static-update.js?v=v3.86',
  ...
  './report-layout.css?v=v3.86',
  './landscape-state.css?v=v3.86',
  './game-detail-enhancement.js?v=v3.86',
  './report-layout.js?v=v3.86',
