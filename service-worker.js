const CACHE_NAME = 'baseball-player-card-pwa-v272';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.72',
  './live-static-update.js?v=v2.72',
  './cpbl-realtime.js?v=v2.72',
  './npb-realtime.js?v=v2.72',
  './app.js?v=v2.72',
  './cpbl-cache-router.js?v=v2.72',
  './game-detail-enhancement.css?v=v2.72',
  './report-layout.css?v=v2.72',
  './landscape-state.css?v=v2.72',
  './game-detail-enhancement.js?v=v2.72',
  './report-layout.js?v=v2.72',
