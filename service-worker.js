const CACHE_NAME = 'baseball-player-card-pwa-v659-auto';
const CACHE_VERSION = 'v6.59';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.59',
  './dark-theme-overrides.css?v=v6.59',
  './diagnostic-runtime.js?v=v6.59',
  './live-static-update.js?v=v6.59',
  './cpbl-realtime.js?v=v6.59',
  './npb-realtime.js?v=v6.59',
  './postseason-history.css?v=v6.59',
  './js/module-loader.js?v=v6.59',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.59',
  './cpbl-cache-router.js?v=v6.59',
  './game-detail-enhancement.css?v=v6.59',
  './report-layout.css?v=v6.59',
  './landscape-state.css?v=v6.59',
  './game-detail-enhancement.js?v=v6.59',
  './report-layout.js?v=v6.59',
  './manifest.webmanifest?v=v6.59',
  './icon-192.png?v=v6.59',
  './icon-512.png?v=v6.59',
  './favicon-32.png?v=v6.59',
  './favicon-16.png?v=v6.59'
];
