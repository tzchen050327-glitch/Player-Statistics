const CACHE_NAME = 'baseball-player-card-pwa-v295-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.95',
  './live-static-update.js?v=v2.95',
  './cpbl-realtime.js?v=v2.95',
  './npb-realtime.js?v=v2.95',
  './postseason-history.css?v=v2.95',
  './app.js?v=v2.95',
  './postseason-history.js?v=v2.95',
  './cpbl-cache-router.js?v=v2.95',
  './game-detail-enhancement.css?v=v2.95',
  './report-layout.css?v=v2.95',
  './landscape-state.css?v=v2.95',
  './game-detail-enhancement.js?v=v2.95',
  './report-layout.js?v=v2.95',
