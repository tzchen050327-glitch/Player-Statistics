const CACHE_NAME = 'baseball-player-card-pwa-v593-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.93',
  './dark-theme-overrides.css?v=v5.93',
  './diagnostic-runtime.js?v=v5.93',
  './live-static-update.js?v=v5.93',
  './cpbl-realtime.js?v=v5.93',
  './npb-realtime.js?v=v5.93',
  './postseason-history.css?v=v5.93',
  './js/module-loader.js?v=v5.93',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v5.93',
  './cpbl-cache-router.js?v=v5.93',
  './game-detail-enhancement.css?v=v5.93',
  './report-layout.css?v=v5.93',
  './landscape-state.css?v=v5.93',
  './game-detail-enhancement.js?v=v5.93',
  './report-layout.js?v=v5.93',
  './manifest.webmanifest?v=v5.93',
  './icon-192.png?v=v5.93',
  './icon-512.png?v=v5.93',
  './favicon-32.png?v=v5.93',
  './favicon-16.png?v=v5.93'
];
