const CACHE_NAME = 'baseball-player-card-pwa-v307-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.07',
  './live-static-update.js?v=v3.07',
  './cpbl-realtime.js?v=v3.07',
  './npb-realtime.js?v=v3.07',
  './postseason-history.css?v=v3.07',
  './app.js?v=v3.07',
  './postseason-history.js?v=v3.07',
  './cpbl-cache-router.js?v=v3.07',
  './game-detail-enhancement.css?v=v3.07',
  './report-layout.css?v=v3.07',
  './landscape-state.css?v=v3.07',
  './game-detail-enhancement.js?v=v3.07',
  './report-layout.js?v=v3.07',
