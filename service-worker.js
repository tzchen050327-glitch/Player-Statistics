const CACHE_NAME = 'baseball-player-card-pwa-v602-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.02',
  './dark-theme-overrides.css?v=v6.02',
  './diagnostic-runtime.js?v=v6.02',
  './live-static-update.js?v=v6.02',
  './cpbl-realtime.js?v=v6.02',
  './npb-realtime.js?v=v6.02',
  './postseason-history.css?v=v6.02',
  './js/module-loader.js?v=v6.02',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.02',
  './cpbl-cache-router.js?v=v6.02',
  './game-detail-enhancement.css?v=v6.02',
  './report-layout.css?v=v6.02',
  './landscape-state.css?v=v6.02',
  './game-detail-enhancement.js?v=v6.02',
  './report-layout.js?v=v6.02',
  './manifest.webmanifest?v=v6.02',
  './icon-192.png?v=v6.02',
  './icon-512.png?v=v6.02',
  './favicon-32.png?v=v6.02',
  './favicon-16.png?v=v6.02'
];
