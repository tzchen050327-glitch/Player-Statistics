const CACHE_NAME = 'baseball-player-card-pwa-v601-auto';
const CACHE_VERSION = 'v6.01';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.01',
  './dark-theme-overrides.css?v=v6.01',
  './diagnostic-runtime.js?v=v6.01',
  './live-static-update.js?v=v6.01',
  './cpbl-realtime.js?v=v6.01',
  './npb-realtime.js?v=v6.01',
  './postseason-history.css?v=v6.01',
  './js/module-loader.js?v=v6.01',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.01',
  './cpbl-cache-router.js?v=v6.01',
  './game-detail-enhancement.css?v=v6.01',
  './report-layout.css?v=v6.01',
  './landscape-state.css?v=v6.01',
  './game-detail-enhancement.js?v=v6.01',
  './report-layout.js?v=v6.01',
  './manifest.webmanifest?v=v6.01',
  './icon-192.png?v=v6.01',
  './icon-512.png?v=v6.01',
  './favicon-32.png?v=v6.01',
  './favicon-16.png?v=v6.01'
];
