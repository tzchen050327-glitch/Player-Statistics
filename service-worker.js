const CACHE_NAME = 'baseball-player-card-pwa-v393-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.93',
  './diagnostic-runtime.js?v=v3.93',
  './live-static-update.js?v=v3.93',
  './cpbl-realtime.js?v=v3.93',
  './npb-realtime.js?v=v3.93',
  './postseason-history.css?v=v3.93',
  './js/module-loader.js?v=v3.93',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.93',
  './cpbl-cache-router.js?v=v3.93',
  './game-detail-enhancement.css?v=v3.93',
  './report-layout.css?v=v3.93',
  './landscape-state.css?v=v3.93',
  './game-detail-enhancement.js?v=v3.93',
  './report-layout.js?v=v3.93',
