const CACHE_NAME = 'baseball-player-card-pwa-v498-auto';
const CACHE_VERSION = 'v4.98';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.98',
  './dark-theme-overrides.css?v=v4.98',
  './diagnostic-runtime.js?v=v4.98',
  './live-static-update.js?v=v4.98',
  './cpbl-realtime.js?v=v4.98',
  './npb-realtime.js?v=v4.98',
  './postseason-history.css?v=v4.98',
  './js/module-loader.js?v=v4.98',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.98',
  './cpbl-cache-router.js?v=v4.98',
  './game-detail-enhancement.css?v=v4.98',
  './report-layout.css?v=v4.98',
  './landscape-state.css?v=v4.98',
  './game-detail-enhancement.js?v=v4.98',
  './report-layout.js?v=v4.98',
  './manifest.webmanifest?v=v4.98',
  './icon-192.png?v=v4.98',
  './icon-512.png?v=v4.98',
  './favicon-32.png?v=v4.98',
  './favicon-16.png?v=v4.98'
];
