const CACHE_NAME = 'baseball-player-card-pwa-v387-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.87',
  './diagnostic-runtime.js?v=v3.87',
  './live-static-update.js?v=v3.87',
  './cpbl-realtime.js?v=v3.87',
  './npb-realtime.js?v=v3.87',
  './postseason-history.css?v=v3.87',
  './js/module-loader.js?v=v3.87',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.87',
  './cpbl-cache-router.js?v=v3.87',
  './game-detail-enhancement.css?v=v3.87',
  './report-layout.css?v=v3.87',
  './landscape-state.css?v=v3.87',
  './game-detail-enhancement.js?v=v3.87',
  './report-layout.js?v=v3.87',
