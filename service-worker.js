const CACHE_NAME = 'baseball-player-card-pwa-v400-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.00',
  './diagnostic-runtime.js?v=v4.00',
  './live-static-update.js?v=v4.00',
  './cpbl-realtime.js?v=v4.00',
  './npb-realtime.js?v=v4.00',
  './postseason-history.css?v=v4.00',
  './js/module-loader.js?v=v4.00',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.00',
  './cpbl-cache-router.js?v=v4.00',
  './game-detail-enhancement.css?v=v4.00',
  './report-layout.css?v=v4.00',
  './landscape-state.css?v=v4.00',
  './game-detail-enhancement.js?v=v4.00',
  './report-layout.js?v=v4.00',
