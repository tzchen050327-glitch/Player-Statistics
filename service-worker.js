const CACHE_NAME = 'baseball-player-card-pwa-v315-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.15',
  './diagnostic-runtime.js?v=v3.15',
  './live-static-update.js?v=v3.15',
  './cpbl-realtime.js?v=v3.15',
  './npb-realtime.js?v=v3.15',
  './postseason-history.css?v=v3.15',
  './app.js?v=v3.15',
  './postseason-history.js?v=v3.15',
  './cpbl-cache-router.js?v=v3.15',
  './game-detail-enhancement.css?v=v3.15',
  './report-layout.css?v=v3.15',
  './landscape-state.css?v=v3.15',
  './game-detail-enhancement.js?v=v3.15',
  './report-layout.js?v=v3.15',
