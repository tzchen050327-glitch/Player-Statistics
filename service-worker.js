const CACHE_NAME = 'baseball-player-card-pwa-v296-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.96',
  './live-static-update.js?v=v2.96',
  './cpbl-realtime.js?v=v2.96',
  './npb-realtime.js?v=v2.96',
  './postseason-history.css?v=v2.96',
  './app.js?v=v2.96',
  './postseason-history.js?v=v2.96',
  './cpbl-cache-router.js?v=v2.96',
  './game-detail-enhancement.css?v=v2.96',
  './report-layout.css?v=v2.96',
  './landscape-state.css?v=v2.96',
  './game-detail-enhancement.js?v=v2.96',
  './report-layout.js?v=v2.96',
