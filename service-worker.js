const CACHE_NAME = 'baseball-player-card-pwa-v313-auto';
// Runtime and app-shell versions are kept in lockstep by auto-version-bump.yml.
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.13',
  './diagnostic-runtime.js?v=v3.13',
  './live-static-update.js?v=v3.13',
  './cpbl-realtime.js?v=v3.13',
  './npb-realtime.js?v=v3.13',
  './postseason-history.css?v=v3.13',
  './app.js?v=v3.13',
  './postseason-history.js?v=v3.13',
  './cpbl-cache-router.js?v=v3.13',
  './game-detail-enhancement.css?v=v3.13',
  './report-layout.css?v=v3.13',
  './landscape-state.css?v=v3.13',
  './game-detail-enhancement.js?v=v3.13',
  './report-layout.js?v=v3.13',
