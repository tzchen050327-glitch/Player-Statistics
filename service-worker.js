const CACHE_NAME = 'baseball-player-card-pwa-v648-auto';
const CACHE_VERSION = 'v6.48';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.48',
  './dark-theme-overrides.css?v=v6.48',
  './diagnostic-runtime.js?v=v6.48',
  './live-static-update.js?v=v6.48',
  './cpbl-realtime.js?v=v6.48',
  './npb-realtime.js?v=v6.48',
  './postseason-history.css?v=v6.48',
  './js/module-loader.js?v=v6.48',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.48',
  './cpbl-cache-router.js?v=v6.48',
  './game-detail-enhancement.css?v=v6.48',
  './report-layout.css?v=v6.48',
  './landscape-state.css?v=v6.48',
  './game-detail-enhancement.js?v=v6.48',
  './report-layout.js?v=v6.48',
  './manifest.webmanifest?v=v6.48',
  './icon-192.png?v=v6.48',
  './icon-512.png?v=v6.48',
  './favicon-32.png?v=v6.48',
  './favicon-16.png?v=v6.48'
];
