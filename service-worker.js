const CACHE_NAME = 'baseball-player-card-pwa-v291-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.91',
  './live-static-update.js?v=v2.91',
  './cpbl-realtime.js?v=v2.91',
  './npb-realtime.js?v=v2.91',
  './postseason-history.css?v=v2.91',
  './app.js?v=v2.91',
  './postseason-history.js?v=v2.91',
  './cpbl-cache-router.js?v=v2.91',
  './game-detail-enhancement.css?v=v2.91',
  './report-layout.css?v=v2.91',
  './landscape-state.css?v=v2.91',
  './game-detail-enhancement.js?v=v2.91',
  './report-layout.js?v=v2.91',
