const CACHE_NAME = 'baseball-player-card-pwa-v293-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.93',
  './live-static-update.js?v=v2.93',
  './cpbl-realtime.js?v=v2.93',
  './npb-realtime.js?v=v2.93',
  './postseason-history.css?v=v2.93',
  './app.js?v=v2.93',
  './postseason-history.js?v=v2.93',
  './cpbl-cache-router.js?v=v2.93',
  './game-detail-enhancement.css?v=v2.93',
  './report-layout.css?v=v2.93',
  './landscape-state.css?v=v2.93',
  './game-detail-enhancement.js?v=v2.93',
  './report-layout.js?v=v2.93',
