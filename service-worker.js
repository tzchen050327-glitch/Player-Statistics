const CACHE_NAME = 'baseball-player-card-pwa-v611-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.11',
  './dark-theme-overrides.css?v=v6.11',
  './diagnostic-runtime.js?v=v6.11',
  './live-static-update.js?v=v6.11',
  './cpbl-realtime.js?v=v6.11',
  './npb-realtime.js?v=v6.11',
  './postseason-history.css?v=v6.11',
  './js/module-loader.js?v=v6.11',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.11',
  './cpbl-cache-router.js?v=v6.11',
  './game-detail-enhancement.css?v=v6.11',
  './report-layout.css?v=v6.11',
  './landscape-state.css?v=v6.11',
  './game-detail-enhancement.js?v=v6.11',
  './report-layout.js?v=v6.11',
  './manifest.webmanifest?v=v6.11',
  './icon-192.png?v=v6.11',
  './icon-512.png?v=v6.11',
  './favicon-32.png?v=v6.11',
  './favicon-16.png?v=v6.11'
];
