const CACHE_NAME = 'baseball-player-card-pwa-v277-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.77',
  './live-static-update.js?v=v2.77',
  './cpbl-realtime.js?v=v2.77',
  './npb-realtime.js?v=v2.77',
  './postseason-history.css?v=v2.77',
  './app.js?v=v2.77',
  './postseason-history.js?v=v2.77',
  './cpbl-cache-router.js?v=v2.77',
  './game-detail-enhancement.css?v=v2.77',
  './report-layout.css?v=v2.77',
  './landscape-state.css?v=v2.77',
  './game-detail-enhancement.js?v=v2.77',
  './report-layout.js?v=v2.77',
