const CACHE_NAME = 'baseball-player-card-pwa-v288-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.88',
  './live-static-update.js?v=v2.88',
  './cpbl-realtime.js?v=v2.88',
  './npb-realtime.js?v=v2.88',
  './postseason-history.css?v=v2.88',
  './app.js?v=v2.88',
  './postseason-history.js?v=v2.88',
  './cpbl-cache-router.js?v=v2.88',
  './game-detail-enhancement.css?v=v2.88',
  './report-layout.css?v=v2.88',
  './landscape-state.css?v=v2.88',
  './game-detail-enhancement.js?v=v2.88',
  './report-layout.js?v=v2.88',
