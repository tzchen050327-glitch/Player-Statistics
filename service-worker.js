const CACHE_NAME = 'baseball-player-card-pwa-v287-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.87',
  './live-static-update.js?v=v2.87',
  './cpbl-realtime.js?v=v2.87',
  './npb-realtime.js?v=v2.87',
  './postseason-history.css?v=v2.87',
  './app.js?v=v2.87',
  './postseason-history.js?v=v2.87',
  './cpbl-cache-router.js?v=v2.87',
  './game-detail-enhancement.css?v=v2.87',
  './report-layout.css?v=v2.87',
  './landscape-state.css?v=v2.87',
  './game-detail-enhancement.js?v=v2.87',
  './report-layout.js?v=v2.87',
