const CACHE_NAME = 'baseball-player-card-pwa-v3100-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.100',
  './diagnostic-runtime.js?v=v3.100',
  './live-static-update.js?v=v3.100',
  './cpbl-realtime.js?v=v3.100',
  './npb-realtime.js?v=v3.100',
  './postseason-history.css?v=v3.100',
  './js/module-loader.js?v=v3.100',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.100',
  './cpbl-cache-router.js?v=v3.100',
  './game-detail-enhancement.css?v=v3.100',
  './report-layout.css?v=v3.100',
  './landscape-state.css?v=v3.100',
  './game-detail-enhancement.js?v=v3.100',
  './report-layout.js?v=v3.100',
