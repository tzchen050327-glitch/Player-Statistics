const CACHE_NAME = 'baseball-player-card-pwa-v604-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.04',
  './dark-theme-overrides.css?v=v6.04',
  './diagnostic-runtime.js?v=v6.04',
  './live-static-update.js?v=v6.04',
  './cpbl-realtime.js?v=v6.04',
  './npb-realtime.js?v=v6.04',
  './postseason-history.css?v=v6.04',
  './js/module-loader.js?v=v6.04',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.04',
  './cpbl-cache-router.js?v=v6.04',
  './game-detail-enhancement.css?v=v6.04',
  './report-layout.css?v=v6.04',
  './landscape-state.css?v=v6.04',
  './game-detail-enhancement.js?v=v6.04',
  './report-layout.js?v=v6.04',
  './manifest.webmanifest?v=v6.04',
  './icon-192.png?v=v6.04',
  './icon-512.png?v=v6.04',
  './favicon-32.png?v=v6.04',
  './favicon-16.png?v=v6.04'
];
