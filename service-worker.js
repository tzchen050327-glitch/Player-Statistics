const CACHE_NAME = 'baseball-player-card-pwa-v283-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.83',
  './live-static-update.js?v=v2.83',
  './cpbl-realtime.js?v=v2.83',
  './npb-realtime.js?v=v2.83',
  './postseason-history.css?v=v2.83',
  './app.js?v=v2.83',
  './postseason-history.js?v=v2.83',
  './cpbl-cache-router.js?v=v2.83',
  './game-detail-enhancement.css?v=v2.83',
  './report-layout.css?v=v2.83',
  './landscape-state.css?v=v2.83',
  './game-detail-enhancement.js?v=v2.83',
  './report-layout.js?v=v2.83',
