const CACHE_NAME = 'baseball-player-card-pwa-v390-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.90',
  './diagnostic-runtime.js?v=v3.90',
  './live-static-update.js?v=v3.90',
  './cpbl-realtime.js?v=v3.90',
  './npb-realtime.js?v=v3.90',
  './postseason-history.css?v=v3.90',
  './js/module-loader.js?v=v3.90',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.90',
  './cpbl-cache-router.js?v=v3.90',
  './game-detail-enhancement.css?v=v3.90',
  './report-layout.css?v=v3.90',
  './landscape-state.css?v=v3.90',
  './game-detail-enhancement.js?v=v3.90',
  './report-layout.js?v=v3.90',
