const CACHE_NAME = 'baseball-player-card-pwa-v402-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.02',
  './diagnostic-runtime.js?v=v4.02',
  './live-static-update.js?v=v4.02',
  './cpbl-realtime.js?v=v4.02',
  './npb-realtime.js?v=v4.02',
  './postseason-history.css?v=v4.02',
  './js/module-loader.js?v=v4.02',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.02',
  './cpbl-cache-router.js?v=v4.02',
  './game-detail-enhancement.css?v=v4.02',
  './report-layout.css?v=v4.02',
