const CACHE_NAME = 'baseball-player-card-pwa-v469-auto';
const CACHE_VERSION = 'v4.69';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.69',
  './dark-theme-overrides.css?v=v4.69',
  './diagnostic-runtime.js?v=v4.69',
  './live-static-update.js?v=v4.69',
  './cpbl-realtime.js?v=v4.69',
  './npb-realtime.js?v=v4.69',
  './postseason-history.css?v=v4.69',
  './js/module-loader.js?v=v4.69',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.69',
  './cpbl-cache-router.js?v=v4.69',
  './game-detail-enhancement.css?v=v4.69',
  './report-layout.css?v=v4.69',
  './landscape-state.css?v=v4.69',
  './game-detail-enhancement.js?v=v4.69',
  './report-layout.js?v=v4.69',
  './manifest.webmanifest?v=v4.69',
  './icon-192.png?v=v4.69',
  './icon-512.png?v=v4.69',
  './favicon-32.png?v=v4.69',
  './favicon-16.png?v=v4.69'
];
