const CACHE_NAME = 'baseball-player-card-pwa-v458-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.58',
  './dark-theme-overrides.css?v=v4.58',
  './diagnostic-runtime.js?v=v4.58',
  './live-static-update.js?v=v4.58',
  './cpbl-realtime.js?v=v4.58',
  './npb-realtime.js?v=v4.58',
  './postseason-history.css?v=v4.58',
  './js/module-loader.js?v=v4.58',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.58',
  './cpbl-cache-router.js?v=v4.58',
  './game-detail-enhancement.css?v=v4.58',
  './report-layout.css?v=v4.58',
  './landscape-state.css?v=v4.58',
  './game-detail-enhancement.js?v=v4.58',
  './report-layout.js?v=v4.58',
  './manifest.webmanifest?v=v4.58',
  './icon-192.png?v=v4.58',
  './icon-512.png?v=v4.58',
  './favicon-32.png?v=v4.58',
  './favicon-16.png?v=v4.58'
];
