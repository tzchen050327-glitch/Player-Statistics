const CACHE_NAME = 'baseball-player-card-pwa-v294-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.94',
  './live-static-update.js?v=v2.94',
  './cpbl-realtime.js?v=v2.94',
  './npb-realtime.js?v=v2.94',
  './postseason-history.css?v=v2.94',
  './app.js?v=v2.94',
  './postseason-history.js?v=v2.94',
  './cpbl-cache-router.js?v=v2.94',
  './game-detail-enhancement.css?v=v2.94',
  './report-layout.css?v=v2.94',
  './landscape-state.css?v=v2.94',
  './game-detail-enhancement.js?v=v2.94',
  './report-layout.js?v=v2.94',
