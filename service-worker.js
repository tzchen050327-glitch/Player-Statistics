const CACHE_NAME = 'baseball-player-card-pwa-v397-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.97',
  './diagnostic-runtime.js?v=v3.97',
  './live-static-update.js?v=v3.97',
  './cpbl-realtime.js?v=v3.97',
  './npb-realtime.js?v=v3.97',
  './postseason-history.css?v=v3.97',
  './js/module-loader.js?v=v3.97',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.97',
  './cpbl-cache-router.js?v=v3.97',
  './game-detail-enhancement.css?v=v3.97',
  './report-layout.css?v=v3.97',
  './landscape-state.css?v=v3.97',
  './game-detail-enhancement.js?v=v3.97',
  './report-layout.js?v=v3.97',
