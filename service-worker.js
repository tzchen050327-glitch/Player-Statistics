const CACHE_NAME = 'baseball-player-card-pwa-v276-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.76',
  './live-static-update.js?v=v2.76',
  './cpbl-realtime.js?v=v2.76',
  './npb-realtime.js?v=v2.76',
  './postseason-history.css?v=v2.76',
  './app.js?v=v2.76',
  './postseason-history.js?v=v2.76',
  './cpbl-cache-router.js?v=v2.76',
  './game-detail-enhancement.css?v=v2.76',
  './report-layout.css?v=v2.76',
  './landscape-state.css?v=v2.76',
  './game-detail-enhancement.js?v=v2.76',
  './report-layout.js?v=v2.76',
