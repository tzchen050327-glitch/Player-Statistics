const CACHE_NAME = 'baseball-player-card-pwa-v289-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.89',
  './live-static-update.js?v=v2.89',
  './cpbl-realtime.js?v=v2.89',
  './npb-realtime.js?v=v2.89',
  './postseason-history.css?v=v2.89',
  './app.js?v=v2.89',
  './postseason-history.js?v=v2.89',
  './cpbl-cache-router.js?v=v2.89',
  './game-detail-enhancement.css?v=v2.89',
  './report-layout.css?v=v2.89',
  './landscape-state.css?v=v2.89',
  './game-detail-enhancement.js?v=v2.89',
  './report-layout.js?v=v2.89',
