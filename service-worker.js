...
const APP_SHELL = [
  ...
  './index.html',
  './styles.css?v=v3.10',
  './live-static-update.js?v=v3.10',
  './cpbl-realtime.js?v=v3.10',
  './npb-realtime.js?v=v3.10',
  './postseason-history.css?v=v3.10',
  './app.js?v=v3.10',
  './postseason-history.js?v=v3.10',
  './cpbl-cache-router.js?v=v3.10',
  './game-detail-enhancement.css?v=v3.10',
  './report-layout.css?v=v3.10',
  './landscape-state.css?v=v3.10',
  './game-detail-enhancement.js?v=v3.10',
  './report-layout.js?v=v3.10',
