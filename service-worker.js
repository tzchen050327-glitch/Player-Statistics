const CACHE_NAME = 'baseball-player-card-pwa-v399-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.99',
  './diagnostic-runtime.js?v=v3.99',
  './live-static-update.js?v=v3.99',
  './cpbl-realtime.js?v=v3.99',
  './npb-realtime.js?v=v3.99',
  './postseason-history.css?v=v3.99',
  './js/module-loader.js?v=v3.99',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.99',
  './cpbl-cache-router.js?v=v3.99',
  './game-detail-enhancement.css?v=v3.99',
  './report-layout.css?v=v3.99',
  './landscape-state.css?v=v3.99',
  './game-detail-enhancement.js?v=v3.99',
  './report-layout.js?v=v3.99',
