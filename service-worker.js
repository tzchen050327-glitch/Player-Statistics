const CACHE_NAME = 'baseball-player-card-pwa-v263';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.63',
  './live-static-update.js?v=v2.63',
  './cpbl-realtime.js?v=v2.63',
  './app.js?v=v2.63',
  './cpbl-cache-router.js?v=v2.63',
  './game-detail-enhancement.css?v=v2.63',
  './report-layout.css?v=v2.63',
  './landscape-state.css?v=v2.63',
  './game-detail-enhancement.js?v=v2.63',
  './report-layout.js?v=v2.63',
