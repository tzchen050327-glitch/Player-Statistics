const CACHE_NAME = 'baseball-player-card-pwa-v528-auto';
const CACHE_VERSION = 'v5.28';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.28',
  './dark-theme-overrides.css?v=v5.28',
  './diagnostic-runtime.js?v=v5.28',
  './live-static-update.js?v=v5.28',
  './cpbl-realtime.js?v=v5.28',
  './npb-realtime.js?v=v5.28',
  './postseason-history.css?v=v5.28',
  './js/module-loader.js?v=v5.28',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v5.28',
  './cpbl-cache-router.js?v=v5.28',
  './game-detail-enhancement.css?v=v5.28',
  './report-layout.css?v=v5.28',
  './landscape-state.css?v=v5.28',
  './game-detail-enhancement.js?v=v5.28',
  './report-layout.js?v=v5.28',
  './manifest.webmanifest?v=v5.28',
  './icon-192.png?v=v5.28',
  './icon-512.png?v=v5.28',
  './favicon-32.png?v=v5.28',
  './favicon-16.png?v=v5.28'
];
