const CACHE_NAME = 'baseball-player-card-pwa-v663-auto';
const CACHE_VERSION = 'v6.63';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.63',
  './dark-theme-overrides.css?v=v6.63',
  './diagnostic-runtime.js?v=v6.63',
  './live-static-update.js?v=v6.63',
  './cpbl-realtime.js?v=v6.63',
  './npb-realtime.js?v=v6.63',
  './postseason-history.css?v=v6.63',
  './js/module-loader.js?v=v6.63',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.63',
  './cpbl-cache-router.js?v=v6.63',
  './game-detail-enhancement.css?v=v6.63',
  './report-layout.css?v=v6.63',
  './landscape-state.css?v=v6.63',
  './game-detail-enhancement.js?v=v6.63',
  './report-layout.js?v=v6.63',
  './manifest.webmanifest?v=v6.63',
  './icon-192.png?v=v6.63',
  './icon-512.png?v=v6.63',
  './favicon-32.png?v=v6.63',
  './favicon-16.png?v=v6.63'
];
