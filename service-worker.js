const CACHE_NAME = 'baseball-player-card-pwa-v280-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.80',
  './live-static-update.js?v=v2.80',
  './cpbl-realtime.js?v=v2.80',
  './npb-realtime.js?v=v2.80',
  './postseason-history.css?v=v2.80',
  './app.js?v=v2.80',
  './postseason-history.js?v=v2.80',
  './cpbl-cache-router.js?v=v2.80',
  './game-detail-enhancement.css?v=v2.80',
  './report-layout.css?v=v2.80',
  './landscape-state.css?v=v2.80',
  './game-detail-enhancement.js?v=v2.80',
  './report-layout.js?v=v2.80',
