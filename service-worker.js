const CACHE_NAME = 'baseball-player-card-pwa-v596-auto';
const CACHE_VERSION = 'v5.96';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.96',
  './dark-theme-overrides.css?v=v5.96',
  './diagnostic-runtime.js?v=v5.96',
  './live-static-update.js?v=v5.96',
  './cpbl-realtime.js?v=v5.96',
  './npb-realtime.js?v=v5.96',
  './postseason-history.css?v=v5.96',
  './js/module-loader.js?v=v5.96',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v5.96',
  './cpbl-cache-router.js?v=v5.96',
  './game-detail-enhancement.css?v=v5.96',
  './report-layout.css?v=v5.96',
  './landscape-state.css?v=v5.96',
  './game-detail-enhancement.js?v=v5.96',
  './report-layout.js?v=v5.96',
  './manifest.webmanifest?v=v5.96',
  './icon-192.png?v=v5.96',
  './icon-512.png?v=v5.96',
  './favicon-32.png?v=v5.96',
  './favicon-16.png?v=v5.96'
];
