const CACHE_NAME = 'baseball-player-card-pwa-v273';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.73',
  './live-static-update.js?v=v2.73',
  './cpbl-realtime.js?v=v2.73',
  './npb-realtime.js?v=v2.73',
  './app.js?v=v2.73',
  './cpbl-cache-router.js?v=v2.73',
  './game-detail-enhancement.css?v=v2.73',
  './report-layout.css?v=v2.73',
  './landscape-state.css?v=v2.73',
  './game-detail-enhancement.js?v=v2.73',
  './report-layout.js?v=v2.73',
