const CACHE_NAME = 'baseball-player-card-pwa-v449-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.49',
  './dark-theme-overrides.css?v=v4.49',
  './diagnostic-runtime.js?v=v4.49',
  './live-static-update.js?v=v4.49',
  './cpbl-realtime.js?v=v4.49',
  './npb-realtime.js?v=v4.49',
  './postseason-history.css?v=v4.49',
  './js/module-loader.js?v=v4.49',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.49',
  './cpbl-cache-router.js?v=v4.49',
  './game-detail-enhancement.css?v=v4.49',
  './report-layout.css?v=v4.49',
  './landscape-state.css?v=v4.49',
  './game-detail-enhancement.js?v=v4.49',
  './report-layout.js?v=v4.49',
  './manifest.webmanifest?v=v4.49',
  './icon-192.png?v=v4.49',
  './icon-512.png?v=v4.49',
  './favicon-32.png?v=v4.49',
  './favicon-16.png?v=v4.49'
];
