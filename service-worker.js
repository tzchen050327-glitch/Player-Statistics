const CACHE_NAME = 'baseball-player-card-pwa-v417-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.17',
  './dark-theme-overrides.css?v=v4.17',
  './diagnostic-runtime.js?v=v4.17',
  './live-static-update.js?v=v4.17',
  './cpbl-realtime.js?v=v4.17',
  './npb-realtime.js?v=v4.17',
  './postseason-history.css?v=v4.17',
  './js/module-loader.js?v=v4.17',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.17',
  './cpbl-cache-router.js?v=v4.17',
  './game-detail-enhancement.css?v=v4.17',
  './report-layout.css?v=v4.17',
  './landscape-state.css?v=v4.17',
  './game-detail-enhancement.js?v=v4.17',
  './report-layout.js?v=v4.17',
  './manifest.webmanifest?v=v4.17',
  './icon-192.png?v=v4.17',
  './icon-512.png?v=v4.17',
  './favicon-32.png?v=v4.17',
  './favicon-16.png?v=v4.17'
];
