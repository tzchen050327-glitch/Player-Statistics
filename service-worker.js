const CACHE_NAME = 'baseball-player-card-pwa-v464-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.64',
  './dark-theme-overrides.css?v=v4.64',
  './diagnostic-runtime.js?v=v4.64',
  './live-static-update.js?v=v4.64',
  './cpbl-realtime.js?v=v4.64',
  './npb-realtime.js?v=v4.64',
  './postseason-history.css?v=v4.64',
  './js/module-loader.js?v=v4.64',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.64',
  './cpbl-cache-router.js?v=v4.64',
  './game-detail-enhancement.css?v=v4.64',
  './report-layout.css?v=v4.64',
  './landscape-state.css?v=v4.64',
  './game-detail-enhancement.js?v=v4.64',
  './report-layout.js?v=v4.64',
  './manifest.webmanifest?v=v4.64',
  './icon-192.png?v=v4.64',
  './icon-512.png?v=v4.64',
  './favicon-32.png?v=v4.64',
  './favicon-16.png?v=v4.64'
];
