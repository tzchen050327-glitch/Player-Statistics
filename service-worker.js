const CACHE_NAME = 'baseball-player-card-pwa-v314-auto';
...
const APP_SHELL = [
  ...
  './cpbl-realtime.js?v=v3.14',
  './npb-realtime.js?v=v3.14',
  './postseason-history.css?v=v3.14',
  './app.js?v=v3.14',
  './postseason-history.js?v=v3.14',
  './cpbl-cache-router.js?v=v3.14',
  './game-detail-enhancement.css?v=v3.14',
  './report-layout.css?v=v3.14',
  './landscape-state.css?v=v3.14',
  './game-detail-enhancement.js?v=v3.14',
  './report-layout.js?v=v3.14',
