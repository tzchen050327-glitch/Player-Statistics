const CACHE_NAME = 'baseball-player-card-pwa-v603-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.03',
  './dark-theme-overrides.css?v=v6.03',
  './diagnostic-runtime.js?v=v6.03',
  './live-static-update.js?v=v6.03',
  './cpbl-realtime.js?v=v6.03',
  './npb-realtime.js?v=v6.03',
  './postseason-history.css?v=v6.03',
  './js/module-loader.js?v=v6.03',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.03',
  './cpbl-cache-router.js?v=v6.03',
  './game-detail-enhancement.css?v=v6.03',
  './report-layout.css?v=v6.03',
  './landscape-state.css?v=v6.03',
  './game-detail-enhancement.js?v=v6.03',
  './report-layout.js?v=v6.03',
  './manifest.webmanifest?v=v6.03',
  './icon-192.png?v=v6.03',
  './icon-512.png?v=v6.03',
  './favicon-32.png?v=v6.03',
  './favicon-16.png?v=v6.03'
];
