const CACHE_NAME = 'baseball-player-card-pwa-v298-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.98',
  './live-static-update.js?v=v2.98',
  './cpbl-realtime.js?v=v2.98',
  './npb-realtime.js?v=v2.98',
  './postseason-history.css?v=v2.98',
  './app.js?v=v2.98',
  './postseason-history.js?v=v2.98',
  './cpbl-cache-router.js?v=v2.98',
  './game-detail-enhancement.css?v=v2.98',
  './report-layout.css?v=v2.98',
  './landscape-state.css?v=v2.98',
  './game-detail-enhancement.js?v=v2.98',
  './report-layout.js?v=v2.98',
