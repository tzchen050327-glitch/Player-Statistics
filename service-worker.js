const CACHE_NAME = 'baseball-player-card-pwa-v274';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.74',
  './live-static-update.js?v=v2.74',
  './cpbl-realtime.js?v=v2.74',
  './npb-realtime.js?v=v2.74',
  './postseason-history.css?v=v2.74',
  './app.js?v=v2.74',
  './postseason-history.js?v=v2.74',
  './cpbl-cache-router.js?v=v2.74',
  './game-detail-enhancement.css?v=v2.74',
  './report-layout.css?v=v2.74',
  './landscape-state.css?v=v2.74',
  './game-detail-enhancement.js?v=v2.74',
  './report-layout.js?v=v2.74',
