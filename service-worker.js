const CACHE_NAME = 'baseball-player-card-pwa-v309-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.09',
  './live-static-update.js?v=v3.09',
  './cpbl-realtime.js?v=v3.09',
  './npb-realtime.js?v=v3.09',
  './postseason-history.css?v=v3.09',
  './app.js?v=v3.09',
  './postseason-history.js?v=v3.09',
  './cpbl-cache-router.js?v=v3.09',
  './game-detail-enhancement.css?v=v3.09',
  './report-layout.css?v=v3.09',
  './landscape-state.css?v=v3.09',
  './game-detail-enhancement.js?v=v3.09',
  './report-layout.js?v=v3.09',
