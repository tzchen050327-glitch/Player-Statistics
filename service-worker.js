const CACHE_NAME = 'baseball-player-card-pwa-v389-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.89',
  './diagnostic-runtime.js?v=v3.89',
  './live-static-update.js?v=v3.89',
  './cpbl-realtime.js?v=v3.89',
  './npb-realtime.js?v=v3.89',
  './postseason-history.css?v=v3.89',
  './js/module-loader.js?v=v3.89',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.89',
  './cpbl-cache-router.js?v=v3.89',
  './game-detail-enhancement.css?v=v3.89',
  './report-layout.css?v=v3.89',
  './landscape-state.css?v=v3.89',
  './game-detail-enhancement.js?v=v3.89',
  './report-layout.js?v=v3.89',
