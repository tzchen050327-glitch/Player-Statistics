const CACHE_NAME = 'baseball-player-card-pwa-v586-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.86',
  './dark-theme-overrides.css?v=v5.86',
  './diagnostic-runtime.js?v=v5.86',
  './live-static-update.js?v=v5.86',
  './cpbl-realtime.js?v=v5.86',
  './npb-realtime.js?v=v5.86',
  './postseason-history.css?v=v5.86',
  './js/module-loader.js?v=v5.86',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v5.86',
  './cpbl-cache-router.js?v=v5.86',
  './game-detail-enhancement.css?v=v5.86',
  './report-layout.css?v=v5.86',
  './landscape-state.css?v=v5.86',
  './game-detail-enhancement.js?v=v5.86',
  './report-layout.js?v=v5.86',
  './manifest.webmanifest?v=v5.86',
  './icon-192.png?v=v5.86',
  './icon-512.png?v=v5.86',
  './favicon-32.png?v=v5.86',
  './favicon-16.png?v=v5.86'
];
