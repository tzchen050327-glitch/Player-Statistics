const CACHE_NAME = 'baseball-player-card-pwa-v590-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.90',
  './dark-theme-overrides.css?v=v5.90',
  './diagnostic-runtime.js?v=v5.90',
  './live-static-update.js?v=v5.90',
  './cpbl-realtime.js?v=v5.90',
  './npb-realtime.js?v=v5.90',
  './postseason-history.css?v=v5.90',
  './js/module-loader.js?v=v5.90',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v5.90',
  './cpbl-cache-router.js?v=v5.90',
  './game-detail-enhancement.css?v=v5.90',
  './report-layout.css?v=v5.90',
  './landscape-state.css?v=v5.90',
  './game-detail-enhancement.js?v=v5.90',
  './report-layout.js?v=v5.90',
  './manifest.webmanifest?v=v5.90',
  './icon-192.png?v=v5.90',
  './icon-512.png?v=v5.90',
  './favicon-32.png?v=v5.90',
  './favicon-16.png?v=v5.90'
];
