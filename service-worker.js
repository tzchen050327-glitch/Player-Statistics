const CACHE_NAME = 'baseball-player-card-pwa-v297-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.97',
  './live-static-update.js?v=v2.97',
  './cpbl-realtime.js?v=v2.97',
  './npb-realtime.js?v=v2.97',
  './postseason-history.css?v=v2.97',
  './app.js?v=v2.97',
  './postseason-history.js?v=v2.97',
  './cpbl-cache-router.js?v=v2.97',
  './game-detail-enhancement.css?v=v2.97',
  './report-layout.css?v=v2.97',
  './landscape-state.css?v=v2.97',
  './game-detail-enhancement.js?v=v2.97',
  './report-layout.js?v=v2.97',
