const CACHE_NAME = 'baseball-player-card-pwa-v592-auto';
const CACHE_VERSION = 'v5.92';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.92',
  './dark-theme-overrides.css?v=v5.92',
  './diagnostic-runtime.js?v=v5.92',
  './live-static-update.js?v=v5.92',
  './cpbl-realtime.js?v=v5.92',
  './npb-realtime.js?v=v5.92',
  './postseason-history.css?v=v5.92',
  './js/module-loader.js?v=v5.92',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v5.92',
  './cpbl-cache-router.js?v=v5.92',
  './game-detail-enhancement.css?v=v5.92',
  './report-layout.css?v=v5.92',
  './landscape-state.css?v=v5.92',
  './game-detail-enhancement.js?v=v5.92',
  './report-layout.js?v=v5.92',
  './manifest.webmanifest?v=v5.92',
  './icon-192.png?v=v5.92',
  './icon-512.png?v=v5.92',
  './favicon-32.png?v=v5.92',
  './favicon-16.png?v=v5.92'
];
