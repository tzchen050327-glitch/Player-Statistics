const CACHE_NAME = 'baseball-player-card-pwa-v478-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.78',
  './dark-theme-overrides.css?v=v4.78',
  './diagnostic-runtime.js?v=v4.78',
  './live-static-update.js?v=v4.78',
  './cpbl-realtime.js?v=v4.78',
  './npb-realtime.js?v=v4.78',
  './postseason-history.css?v=v4.78',
  './js/module-loader.js?v=v4.78',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.78',
  './cpbl-cache-router.js?v=v4.78',
  './game-detail-enhancement.css?v=v4.78',
  './report-layout.css?v=v4.78',
  './landscape-state.css?v=v4.78',
  './game-detail-enhancement.js?v=v4.78',
  './report-layout.js?v=v4.78',
  './manifest.webmanifest?v=v4.78',
  './icon-192.png?v=v4.78',
  './icon-512.png?v=v4.78',
  './favicon-32.png?v=v4.78',
  './favicon-16.png?v=v4.78'
];
