const CACHE_NAME = 'baseball-player-card-pwa-v598-auto';
const CACHE_VERSION = 'v5.98';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.98',
  './dark-theme-overrides.css?v=v5.98',
  './diagnostic-runtime.js?v=v5.98',
  './live-static-update.js?v=v5.98',
  './cpbl-realtime.js?v=v5.98',
  './npb-realtime.js?v=v5.98',
  './postseason-history.css?v=v5.98',
  './js/module-loader.js?v=v5.98',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v5.98',
  './cpbl-cache-router.js?v=v5.98',
  './game-detail-enhancement.css?v=v5.98',
  './report-layout.css?v=v5.98',
  './landscape-state.css?v=v5.98',
  './game-detail-enhancement.js?v=v5.98',
  './report-layout.js?v=v5.98',
  './manifest.webmanifest?v=v5.98',
  './icon-192.png?v=v5.98',
  './icon-512.png?v=v5.98',
  './favicon-32.png?v=v5.98',
  './favicon-16.png?v=v5.98'
];
