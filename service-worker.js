const CACHE_NAME = 'baseball-player-card-pwa-v580-auto';
const CACHE_VERSION = 'v5.80';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.80',
  './dark-theme-overrides.css?v=v5.80',
  './diagnostic-runtime.js?v=v5.80',
  './live-static-update.js?v=v5.80',
  './cpbl-realtime.js?v=v5.80',
  './npb-realtime.js?v=v5.80',
  './postseason-history.css?v=v5.80',
  './js/module-loader.js?v=v5.80',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v5.80',
  './cpbl-cache-router.js?v=v5.80',
  './game-detail-enhancement.css?v=v5.80',
  './report-layout.css?v=v5.80',
  './landscape-state.css?v=v5.80',
  './game-detail-enhancement.js?v=v5.80',
  './report-layout.js?v=v5.80',
  './manifest.webmanifest?v=v5.80',
  './icon-192.png?v=v5.80',
  './icon-512.png?v=v5.80',
  './favicon-32.png?v=v5.80',
  './favicon-16.png?v=v5.80'
];
