const CACHE_NAME = 'baseball-player-card-pwa-v299-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.99',
  './live-static-update.js?v=v2.99',
  './cpbl-realtime.js?v=v2.99',
  './npb-realtime.js?v=v2.99',
  './postseason-history.css?v=v2.99',
  './app.js?v=v2.99',
  './postseason-history.js?v=v2.99',
  './cpbl-cache-router.js?v=v2.99',
  './game-detail-enhancement.css?v=v2.99',
  './report-layout.css?v=v2.99',
  './landscape-state.css?v=v2.99',
  './game-detail-enhancement.js?v=v2.99',
  './report-layout.js?v=v2.99',
