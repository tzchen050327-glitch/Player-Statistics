const CACHE_NAME = 'baseball-player-card-pwa-v448-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.48',
  './dark-theme-overrides.css?v=v4.48',
  './diagnostic-runtime.js?v=v4.48',
  './live-static-update.js?v=v4.48',
  './cpbl-realtime.js?v=v4.48',
  './npb-realtime.js?v=v4.48',
  './postseason-history.css?v=v4.48',
  './js/module-loader.js?v=v4.48',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.48',
  './cpbl-cache-router.js?v=v4.48',
  './game-detail-enhancement.css?v=v4.48',
  './report-layout.css?v=v4.48',
  './landscape-state.css?v=v4.48',
  './game-detail-enhancement.js?v=v4.48',
  './report-layout.js?v=v4.48',
  './manifest.webmanifest?v=v4.48',
  './icon-192.png?v=v4.48',
  './icon-512.png?v=v4.48',
  './favicon-32.png?v=v4.48',
  './favicon-16.png?v=v4.48'
];
