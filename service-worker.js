const CACHE_NAME = 'baseball-player-card-pwa-v641-auto';
const CACHE_VERSION = 'v6.41';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.41',
  './dark-theme-overrides.css?v=v6.41',
  './diagnostic-runtime.js?v=v6.41',
  './live-static-update.js?v=v6.41',
  './cpbl-realtime.js?v=v6.41',
  './npb-realtime.js?v=v6.41',
  './postseason-history.css?v=v6.41',
  './js/module-loader.js?v=v6.41',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.41',
  './cpbl-cache-router.js?v=v6.41',
  './game-detail-enhancement.css?v=v6.41',
  './report-layout.css?v=v6.41',
  './landscape-state.css?v=v6.41',
  './game-detail-enhancement.js?v=v6.41',
  './report-layout.js?v=v6.41',
  './manifest.webmanifest?v=v6.41',
  './icon-192.png?v=v6.41',
  './icon-512.png?v=v6.41',
  './favicon-32.png?v=v6.41',
  './favicon-16.png?v=v6.41'
];
