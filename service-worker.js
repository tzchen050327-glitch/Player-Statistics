const CACHE_NAME = 'baseball-player-card-pwa-v414-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.14',
  './dark-theme-overrides.css?v=v4.14',
  './diagnostic-runtime.js?v=v4.14',
  './live-static-update.js?v=v4.14',
  './cpbl-realtime.js?v=v4.14',
  './npb-realtime.js?v=v4.14',
  './postseason-history.css?v=v4.14',
  './js/module-loader.js?v=v4.14',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.14',
  './cpbl-cache-router.js?v=v4.14',
  './game-detail-enhancement.css?v=v4.14',
  './report-layout.css?v=v4.14',
  './landscape-state.css?v=v4.14',
  './game-detail-enhancement.js?v=v4.14',
  './report-layout.js?v=v4.14',
  './manifest.webmanifest?v=v4.14',
  './icon-192.png?v=v4.14',
  './icon-512.png?v=v4.14',
  './favicon-32.png?v=v4.14',
  './favicon-16.png?v=v4.14'
];
