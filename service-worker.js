const CACHE_NAME = 'baseball-player-card-pwa-v481-auto';
const CACHE_VERSION = 'v4.81';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.81',
  './dark-theme-overrides.css?v=v4.81',
  './diagnostic-runtime.js?v=v4.81',
  './live-static-update.js?v=v4.81',
  './cpbl-realtime.js?v=v4.81',
  './npb-realtime.js?v=v4.81',
  './postseason-history.css?v=v4.81',
  './js/module-loader.js?v=v4.81',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.81',
  './cpbl-cache-router.js?v=v4.81',
  './game-detail-enhancement.css?v=v4.81',
  './report-layout.css?v=v4.81',
  './landscape-state.css?v=v4.81',
  './game-detail-enhancement.js?v=v4.81',
  './report-layout.js?v=v4.81',
  './manifest.webmanifest?v=v4.81',
  './icon-192.png?v=v4.81',
  './icon-512.png?v=v4.81',
  './favicon-32.png?v=v4.81',
  './favicon-16.png?v=v4.81'
];
