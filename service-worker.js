const CACHE_NAME = 'baseball-player-card-pwa-v656-auto';
const CACHE_VERSION = 'v6.56';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.56',
  './dark-theme-overrides.css?v=v6.56',
  './diagnostic-runtime.js?v=v6.56',
  './live-static-update.js?v=v6.56',
  './cpbl-realtime.js?v=v6.56',
  './npb-realtime.js?v=v6.56',
  './postseason-history.css?v=v6.56',
  './js/module-loader.js?v=v6.56',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.56',
  './cpbl-cache-router.js?v=v6.56',
  './game-detail-enhancement.css?v=v6.56',
  './report-layout.css?v=v6.56',
  './landscape-state.css?v=v6.56',
  './game-detail-enhancement.js?v=v6.56',
  './report-layout.js?v=v6.56',
  './manifest.webmanifest?v=v6.56',
  './icon-192.png?v=v6.56',
  './icon-512.png?v=v6.56',
  './favicon-32.png?v=v6.56',
  './favicon-16.png?v=v6.56'
];
