const CACHE_NAME = 'baseball-player-card-pwa-v664-auto';
const CACHE_VERSION = 'v6.64';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.64',
  './dark-theme-overrides.css?v=v6.64',
  './diagnostic-runtime.js?v=v6.64',
  './live-static-update.js?v=v6.64',
  './cpbl-realtime.js?v=v6.64',
  './npb-realtime.js?v=v6.64',
  './postseason-history.css?v=v6.64',
  './js/module-loader.js?v=v6.64',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.64',
  './cpbl-cache-router.js?v=v6.64',
  './game-detail-enhancement.css?v=v6.64',
  './report-layout.css?v=v6.64',
  './landscape-state.css?v=v6.64',
  './game-detail-enhancement.js?v=v6.64',
  './report-layout.js?v=v6.64',
  './manifest.webmanifest?v=v6.64',
  './icon-192.png?v=v6.64',
  './icon-512.png?v=v6.64',
  './favicon-32.png?v=v6.64',
  './favicon-16.png?v=v6.64'
];
