const CACHE_NAME = 'baseball-player-card-pwa-v640-auto';
const CACHE_VERSION = 'v6.40';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.40',
  './dark-theme-overrides.css?v=v6.40',
  './diagnostic-runtime.js?v=v6.40',
  './live-static-update.js?v=v6.40',
  './cpbl-realtime.js?v=v6.40',
  './npb-realtime.js?v=v6.40',
  './postseason-history.css?v=v6.40',
  './js/module-loader.js?v=v6.40',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.40',
  './cpbl-cache-router.js?v=v6.40',
  './game-detail-enhancement.css?v=v6.40',
  './report-layout.css?v=v6.40',
  './landscape-state.css?v=v6.40',
  './game-detail-enhancement.js?v=v6.40',
  './report-layout.js?v=v6.40',
  './manifest.webmanifest?v=v6.40',
  './icon-192.png?v=v6.40',
  './icon-512.png?v=v6.40',
  './favicon-32.png?v=v6.40',
  './favicon-16.png?v=v6.40'
];
