const CACHE_NAME = 'baseball-player-card-pwa-v308-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.08',
  './live-static-update.js?v=v3.08',
  './cpbl-realtime.js?v=v3.08',
  './npb-realtime.js?v=v3.08',
  './postseason-history.css?v=v3.08',
  './app.js?v=v3.08',
  './postseason-history.js?v=v3.08',
  './cpbl-cache-router.js?v=v3.08',
  './game-detail-enhancement.css?v=v3.08',
  './report-layout.css?v=v3.08',
  './landscape-state.css?v=v3.08',
  './game-detail-enhancement.js?v=v3.08',
  './report-layout.js?v=v3.08',
