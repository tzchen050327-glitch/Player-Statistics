const CACHE_NAME = 'baseball-player-card-pwa-v394-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.94',
  './diagnostic-runtime.js?v=v3.94',
  './live-static-update.js?v=v3.94',
  './cpbl-realtime.js?v=v3.94',
  './npb-realtime.js?v=v3.94',
  './postseason-history.css?v=v3.94',
  './js/module-loader.js?v=v3.94',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.94',
  './cpbl-cache-router.js?v=v3.94',
  './game-detail-enhancement.css?v=v3.94',
  './report-layout.css?v=v3.94',
  './landscape-state.css?v=v3.94',
  './game-detail-enhancement.js?v=v3.94',
  './report-layout.js?v=v3.94',
