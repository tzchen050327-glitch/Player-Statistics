const CACHE_NAME = 'baseball-player-card-pwa-v278-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.78',
  './live-static-update.js?v=v2.78',
  './cpbl-realtime.js?v=v2.78',
  './npb-realtime.js?v=v2.78',
  './postseason-history.css?v=v2.78',
  './app.js?v=v2.78',
  './postseason-history.js?v=v2.78',
  './cpbl-cache-router.js?v=v2.78',
  './game-detail-enhancement.css?v=v2.78',
  './report-layout.css?v=v2.78',
  './landscape-state.css?v=v2.78',
  './game-detail-enhancement.js?v=v2.78',
  './report-layout.js?v=v2.78',
