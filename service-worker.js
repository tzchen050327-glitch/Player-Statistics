const CACHE_NAME = 'baseball-player-card-pwa-v445-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.45',
  './dark-theme-overrides.css?v=v4.45',
  './diagnostic-runtime.js?v=v4.45',
  './live-static-update.js?v=v4.45',
  './cpbl-realtime.js?v=v4.45',
  './npb-realtime.js?v=v4.45',
  './postseason-history.css?v=v4.45',
  './js/module-loader.js?v=v4.45',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.45',
  './cpbl-cache-router.js?v=v4.45',
  './game-detail-enhancement.css?v=v4.45',
  './report-layout.css?v=v4.45',
  './landscape-state.css?v=v4.45',
  './game-detail-enhancement.js?v=v4.45',
  './report-layout.js?v=v4.45',
  './manifest.webmanifest?v=v4.45',
  './icon-192.png?v=v4.45',
  './icon-512.png?v=v4.45',
  './favicon-32.png?v=v4.45',
  './favicon-16.png?v=v4.45'
];
