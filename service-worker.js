const CACHE_NAME = 'baseball-player-card-pwa-v576-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.76',
  './dark-theme-overrides.css?v=v5.76',
  './diagnostic-runtime.js?v=v5.76',
  './live-static-update.js?v=v5.76',
  './cpbl-realtime.js?v=v5.76',
  './npb-realtime.js?v=v5.76',
  './postseason-history.css?v=v5.76',
  './js/module-loader.js?v=v5.76',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v5.76',
  './cpbl-cache-router.js?v=v5.76',
  './game-detail-enhancement.css?v=v5.76',
  './report-layout.css?v=v5.76',
  './landscape-state.css?v=v5.76',
  './game-detail-enhancement.js?v=v5.76',
  './report-layout.js?v=v5.76',
  './manifest.webmanifest?v=v5.76',
  './icon-192.png?v=v5.76',
  './icon-512.png?v=v5.76',
  './favicon-32.png?v=v5.76',
  './favicon-16.png?v=v5.76'
];
