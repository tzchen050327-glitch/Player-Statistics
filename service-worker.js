const CACHE_NAME = 'baseball-player-card-pwa-v650-auto';
const CACHE_VERSION = 'v6.50';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.50',
  './dark-theme-overrides.css?v=v6.50',
  './diagnostic-runtime.js?v=v6.50',
  './live-static-update.js?v=v6.50',
  './cpbl-realtime.js?v=v6.50',
  './npb-realtime.js?v=v6.50',
  './postseason-history.css?v=v6.50',
  './js/module-loader.js?v=v6.50',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.50',
  './cpbl-cache-router.js?v=v6.50',
  './game-detail-enhancement.css?v=v6.50',
  './report-layout.css?v=v6.50',
  './landscape-state.css?v=v6.50',
  './game-detail-enhancement.js?v=v6.50',
  './report-layout.js?v=v6.50',
  './manifest.webmanifest?v=v6.50',
  './icon-192.png?v=v6.50',
  './icon-512.png?v=v6.50',
  './favicon-32.png?v=v6.50',
  './favicon-16.png?v=v6.50'
];
