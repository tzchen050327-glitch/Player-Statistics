const CACHE_NAME = 'baseball-player-card-pwa-v305-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.05',
  './live-static-update.js?v=v3.05',
  './cpbl-realtime.js?v=v3.05',
  './npb-realtime.js?v=v3.05',
  './postseason-history.css?v=v3.05',
  './app.js?v=v3.05',
  './postseason-history.js?v=v3.05',
  './cpbl-cache-router.js?v=v3.05',
  './game-detail-enhancement.css?v=v3.05',
  './report-layout.css?v=v3.05',
  './landscape-state.css?v=v3.05',
  './game-detail-enhancement.js?v=v3.05',
  './report-layout.js?v=v3.05',
