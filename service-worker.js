const CACHE_NAME = 'baseball-player-card-pwa-v290-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.90',
  './live-static-update.js?v=v2.90',
  './cpbl-realtime.js?v=v2.90',
  './npb-realtime.js?v=v2.90',
  './postseason-history.css?v=v2.90',
  './app.js?v=v2.90',
  './postseason-history.js?v=v2.90',
  './cpbl-cache-router.js?v=v2.90',
  './game-detail-enhancement.css?v=v2.90',
  './report-layout.css?v=v2.90',
  './landscape-state.css?v=v2.90',
  './game-detail-enhancement.js?v=v2.90',
  './report-layout.js?v=v2.90',
