const CACHE_NAME = 'baseball-player-card-pwa-v306-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.06',
  './live-static-update.js?v=v3.06',
  './cpbl-realtime.js?v=v3.06',
  './npb-realtime.js?v=v3.06',
  './postseason-history.css?v=v3.06',
  './app.js?v=v3.06',
  './postseason-history.js?v=v3.06',
  './cpbl-cache-router.js?v=v3.06',
  './game-detail-enhancement.css?v=v3.06',
  './report-layout.css?v=v3.06',
  './landscape-state.css?v=v3.06',
  './game-detail-enhancement.js?v=v3.06',
  './report-layout.js?v=v3.06',
