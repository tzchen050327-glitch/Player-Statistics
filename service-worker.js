const CACHE_NAME = 'baseball-player-card-pwa-v463-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.63',
  './dark-theme-overrides.css?v=v4.63',
  './diagnostic-runtime.js?v=v4.63',
  './live-static-update.js?v=v4.63',
  './cpbl-realtime.js?v=v4.63',
  './npb-realtime.js?v=v4.63',
  './postseason-history.css?v=v4.63',
  './js/module-loader.js?v=v4.63',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.63',
  './cpbl-cache-router.js?v=v4.63',
  './game-detail-enhancement.css?v=v4.63',
  './report-layout.css?v=v4.63',
  './landscape-state.css?v=v4.63',
  './game-detail-enhancement.js?v=v4.63',
  './report-layout.js?v=v4.63',
  './manifest.webmanifest?v=v4.63',
  './icon-192.png?v=v4.63',
  './icon-512.png?v=v4.63',
  './favicon-32.png?v=v4.63',
  './favicon-16.png?v=v4.63'
];
