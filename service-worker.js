const CACHE_NAME = 'baseball-player-card-pwa-v281-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.81',
  './live-static-update.js?v=v2.81',
  './cpbl-realtime.js?v=v2.81',
  './npb-realtime.js?v=v2.81',
  './postseason-history.css?v=v2.81',
  './app.js?v=v2.81',
  './postseason-history.js?v=v2.81',
  './cpbl-cache-router.js?v=v2.81',
  './game-detail-enhancement.css?v=v2.81',
  './report-layout.css?v=v2.81',
  './landscape-state.css?v=v2.81',
  './game-detail-enhancement.js?v=v2.81',
  './report-layout.js?v=v2.81',
