const CACHE_NAME = 'baseball-player-card-pwa-v582-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.82',
  './dark-theme-overrides.css?v=v5.82',
  './diagnostic-runtime.js?v=v5.82',
  './live-static-update.js?v=v5.82',
  './cpbl-realtime.js?v=v5.82',
  './npb-realtime.js?v=v5.82',
  './postseason-history.css?v=v5.82',
  './js/module-loader.js?v=v5.82',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v5.82',
  './cpbl-cache-router.js?v=v5.82',
  './game-detail-enhancement.css?v=v5.82',
  './report-layout.css?v=v5.82',
  './landscape-state.css?v=v5.82',
  './game-detail-enhancement.js?v=v5.82',
  './report-layout.js?v=v5.82',
  './manifest.webmanifest?v=v5.82',
  './icon-192.png?v=v5.82',
  './icon-512.png?v=v5.82',
  './favicon-32.png?v=v5.82',
  './favicon-16.png?v=v5.82'
];
