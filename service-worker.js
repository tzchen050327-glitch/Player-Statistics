const CACHE_NAME = 'baseball-player-card-pwa-v413-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.13',
  './dark-theme-overrides.css?v=v4.13',
  './diagnostic-runtime.js?v=v4.13',
  './live-static-update.js?v=v4.13',
  './cpbl-realtime.js?v=v4.13',
  './npb-realtime.js?v=v4.13',
  './postseason-history.css?v=v4.13',
  './js/module-loader.js?v=v4.13',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.13',
  './cpbl-cache-router.js?v=v4.13',
  './game-detail-enhancement.css?v=v4.13',
  './report-layout.css?v=v4.13',
  './landscape-state.css?v=v4.13',
  './game-detail-enhancement.js?v=v4.13',
  './report-layout.js?v=v4.13',
  './manifest.webmanifest?v=v4.13',
  './icon-192.png?v=v4.13',
  './icon-512.png?v=v4.13',
  './favicon-32.png?v=v4.13',
  './favicon-16.png?v=v4.13'
];
