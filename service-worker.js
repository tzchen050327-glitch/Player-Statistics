const CACHE_NAME = 'baseball-player-card-pwa-v401-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.01',
  './diagnostic-runtime.js?v=v4.01',
  './live-static-update.js?v=v4.01',
  './cpbl-realtime.js?v=v4.01',
  './npb-realtime.js?v=v4.01',
  './postseason-history.css?v=v4.01',
  './js/module-loader.js?v=v4.01',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.01',
  './cpbl-cache-router.js?v=v4.01',
  './game-detail-enhancement.css?v=v4.01',
  './report-layout.css?v=v4.01',
  './landscape-state.css?v=v4.01',
  './game-detail-enhancement.js?v=v4.01',
  './report-layout.js?v=v4.01',
