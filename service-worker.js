const CACHE_NAME = 'baseball-player-card-pwa-v300-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.00',
  './live-static-update.js?v=v3.00',
  './cpbl-realtime.js?v=v3.00',
  './npb-realtime.js?v=v3.00',
  './postseason-history.css?v=v3.00',
  './app.js?v=v3.00',
  './postseason-history.js?v=v3.00',
  './cpbl-cache-router.js?v=v3.00',
  './game-detail-enhancement.css?v=v3.00',
  './report-layout.css?v=v3.00',
  './landscape-state.css?v=v3.00',
  './game-detail-enhancement.js?v=v3.00',
  './report-layout.js?v=v3.00',
