const CACHE_NAME = 'baseball-player-card-pwa-v624-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.24',
  './dark-theme-overrides.css?v=v6.24',
  './diagnostic-runtime.js?v=v6.24',
  './live-static-update.js?v=v6.24',
  './cpbl-realtime.js?v=v6.24',
  './npb-realtime.js?v=v6.24',
  './postseason-history.css?v=v6.24',
  './js/module-loader.js?v=v6.24',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.24',
  './cpbl-cache-router.js?v=v6.24',
  './game-detail-enhancement.css?v=v6.24',
  './report-layout.css?v=v6.24',
  './landscape-state.css?v=v6.24',
  './game-detail-enhancement.js?v=v6.24',
  './report-layout.js?v=v6.24',
  './manifest.webmanifest?v=v6.24',
  './icon-192.png?v=v6.24',
  './icon-512.png?v=v6.24',
  './favicon-32.png?v=v6.24',
  './favicon-16.png?v=v6.24'
];
