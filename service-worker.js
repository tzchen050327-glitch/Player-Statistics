const CACHE_NAME = 'baseball-player-card-pwa-v286-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v2.86',
  './live-static-update.js?v=v2.86',
  './cpbl-realtime.js?v=v2.86',
  './npb-realtime.js?v=v2.86',
  './postseason-history.css?v=v2.86',
  './app.js?v=v2.86',
  './postseason-history.js?v=v2.86',
  './cpbl-cache-router.js?v=v2.86',
  './game-detail-enhancement.css?v=v2.86',
  './report-layout.css?v=v2.86',
  './landscape-state.css?v=v2.86',
  './game-detail-enhancement.js?v=v2.86',
  './report-layout.js?v=v2.86',
