const CACHE_NAME = 'baseball-player-card-pwa-v651-auto';
const CACHE_VERSION = 'v6.51';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.51',
  './dark-theme-overrides.css?v=v6.51',
  './diagnostic-runtime.js?v=v6.51',
  './live-static-update.js?v=v6.51',
  './cpbl-realtime.js?v=v6.51',
  './npb-realtime.js?v=v6.51',
  './postseason-history.css?v=v6.51',
  './js/module-loader.js?v=v6.51',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.51',
  './cpbl-cache-router.js?v=v6.51',
  './game-detail-enhancement.css?v=v6.51',
  './report-layout.css?v=v6.51',
  './landscape-state.css?v=v6.51',
  './game-detail-enhancement.js?v=v6.51',
  './report-layout.js?v=v6.51',
  './manifest.webmanifest?v=v6.51',
  './icon-192.png?v=v6.51',
  './icon-512.png?v=v6.51',
  './favicon-32.png?v=v6.51',
  './favicon-16.png?v=v6.51'
];
