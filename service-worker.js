const CACHE_NAME = 'baseball-player-card-pwa-v653-auto';
const CACHE_VERSION = 'v6.53';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.53',
  './dark-theme-overrides.css?v=v6.53',
  './diagnostic-runtime.js?v=v6.53',
  './live-static-update.js?v=v6.53',
  './cpbl-realtime.js?v=v6.53',
  './npb-realtime.js?v=v6.53',
  './postseason-history.css?v=v6.53',
  './js/module-loader.js?v=v6.53',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.53',
  './cpbl-cache-router.js?v=v6.53',
  './game-detail-enhancement.css?v=v6.53',
  './report-layout.css?v=v6.53',
  './landscape-state.css?v=v6.53',
  './game-detail-enhancement.js?v=v6.53',
  './report-layout.js?v=v6.53',
  './manifest.webmanifest?v=v6.53',
  './icon-192.png?v=v6.53',
  './icon-512.png?v=v6.53',
  './favicon-32.png?v=v6.53',
  './favicon-16.png?v=v6.53'
];
