const CACHE_NAME = 'baseball-player-card-pwa-v662-auto';
const CACHE_VERSION = 'v6.62';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.62',
  './dark-theme-overrides.css?v=v6.62',
  './diagnostic-runtime.js?v=v6.62',
  './live-static-update.js?v=v6.62',
  './cpbl-realtime.js?v=v6.62',
  './npb-realtime.js?v=v6.62',
  './postseason-history.css?v=v6.62',
  './js/module-loader.js?v=v6.62',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.62',
  './cpbl-cache-router.js?v=v6.62',
  './game-detail-enhancement.css?v=v6.62',
  './report-layout.css?v=v6.62',
  './landscape-state.css?v=v6.62',
  './game-detail-enhancement.js?v=v6.62',
  './report-layout.js?v=v6.62',
  './manifest.webmanifest?v=v6.62',
  './icon-192.png?v=v6.62',
  './icon-512.png?v=v6.62',
  './favicon-32.png?v=v6.62',
  './favicon-16.png?v=v6.62'
];
