const CACHE_NAME = 'baseball-player-card-pwa-v609-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.09',
  './dark-theme-overrides.css?v=v6.09',
  './diagnostic-runtime.js?v=v6.09',
  './live-static-update.js?v=v6.09',
  './cpbl-realtime.js?v=v6.09',
  './npb-realtime.js?v=v6.09',
  './postseason-history.css?v=v6.09',
  './js/module-loader.js?v=v6.09',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.09',
  './cpbl-cache-router.js?v=v6.09',
  './game-detail-enhancement.css?v=v6.09',
  './report-layout.css?v=v6.09',
  './landscape-state.css?v=v6.09',
  './game-detail-enhancement.js?v=v6.09',
  './report-layout.js?v=v6.09',
  './manifest.webmanifest?v=v6.09',
  './icon-192.png?v=v6.09',
  './icon-512.png?v=v6.09',
  './favicon-32.png?v=v6.09',
  './favicon-16.png?v=v6.09'
];
