const CACHE_NAME = 'baseball-player-card-pwa-v584-auto';
const CACHE_VERSION = 'v5.84';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.84',
  './dark-theme-overrides.css?v=v5.84',
  './diagnostic-runtime.js?v=v5.84',
  './live-static-update.js?v=v5.84',
  './cpbl-realtime.js?v=v5.84',
  './npb-realtime.js?v=v5.84',
  './postseason-history.css?v=v5.84',
  './js/module-loader.js?v=v5.84',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v5.84',
  './cpbl-cache-router.js?v=v5.84',
  './game-detail-enhancement.css?v=v5.84',
  './report-layout.css?v=v5.84',
  './landscape-state.css?v=v5.84',
  './game-detail-enhancement.js?v=v5.84',
  './report-layout.js?v=v5.84',
  './manifest.webmanifest?v=v5.84',
  './icon-192.png?v=v5.84',
  './icon-512.png?v=v5.84',
  './favicon-32.png?v=v5.84',
  './favicon-16.png?v=v5.84'
];
