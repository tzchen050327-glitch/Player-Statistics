const CACHE_NAME = 'baseball-player-card-pwa-v304-postseason-years1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=v3.04',
  './live-static-update.js?v=v3.04',
  './cpbl-realtime.js?v=v3.04',
  './npb-realtime.js?v=v3.04',
  './postseason-history.css?v=v3.04',
  './app.js?v=v3.04',
  './postseason-history.js?v=v3.04',
  './cpbl-cache-router.js?v=v3.04',
  './game-detail-enhancement.css?v=v3.04',
  './report-layout.css?v=v3.04',
  './landscape-state.css?v=v3.04',
  './game-detail-enhancement.js?v=v3.04',
  './report-layout.js?v=v3.04',
