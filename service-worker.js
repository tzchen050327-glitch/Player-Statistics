const CACHE_NAME = 'baseball-player-card-pwa-v566-auto';
const CACHE_VERSION = 'v5.66';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.66',
  './dark-theme-overrides.css?v=v5.66',
  './diagnostic-runtime.js?v=v5.66',
  './live-static-update.js?v=v5.66',
  './cpbl-realtime.js?v=v5.66',
  './npb-realtime.js?v=v5.66',
  './postseason-history.css?v=v5.66',
  './js/module-loader.js?v=v5.66',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v5.66',
  './cpbl-cache-router.js?v=v5.66',
  './game-detail-enhancement.css?v=v5.66',
  './report-layout.css?v=v5.66',
  './landscape-state.css?v=v5.66',
  './game-detail-enhancement.js?v=v5.66',
  './report-layout.js?v=v5.66',
  './manifest.webmanifest?v=v5.66',
  './icon-192.png?v=v5.66',
  './icon-512.png?v=v5.66',
  './favicon-32.png?v=v5.66',
  './favicon-16.png?v=v5.66'
];
