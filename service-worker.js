const CACHE_NAME = 'baseball-player-card-pwa-v652-auto';
const CACHE_VERSION = 'v6.52';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.52',
  './dark-theme-overrides.css?v=v6.52',
  './diagnostic-runtime.js?v=v6.52',
  './live-static-update.js?v=v6.52',
  './cpbl-realtime.js?v=v6.52',
  './npb-realtime.js?v=v6.52',
  './postseason-history.css?v=v6.52',
  './js/module-loader.js?v=v6.52',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.52',
  './cpbl-cache-router.js?v=v6.52',
  './game-detail-enhancement.css?v=v6.52',
  './report-layout.css?v=v6.52',
  './landscape-state.css?v=v6.52',
  './game-detail-enhancement.js?v=v6.52',
  './report-layout.js?v=v6.52',
  './manifest.webmanifest?v=v6.52',
  './icon-192.png?v=v6.52',
  './icon-512.png?v=v6.52',
  './favicon-32.png?v=v6.52',
  './favicon-16.png?v=v6.52'
];
