const CACHE_NAME = 'baseball-player-card-pwa-v608-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.08',
  './dark-theme-overrides.css?v=v6.08',
  './diagnostic-runtime.js?v=v6.08',
  './live-static-update.js?v=v6.08',
  './cpbl-realtime.js?v=v6.08',
  './npb-realtime.js?v=v6.08',
  './postseason-history.css?v=v6.08',
  './js/module-loader.js?v=v6.08',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.08',
  './cpbl-cache-router.js?v=v6.08',
  './game-detail-enhancement.css?v=v6.08',
  './report-layout.css?v=v6.08',
  './landscape-state.css?v=v6.08',
  './game-detail-enhancement.js?v=v6.08',
  './report-layout.js?v=v6.08',
  './manifest.webmanifest?v=v6.08',
  './icon-192.png?v=v6.08',
  './icon-512.png?v=v6.08',
  './favicon-32.png?v=v6.08',
  './favicon-16.png?v=v6.08'
];
