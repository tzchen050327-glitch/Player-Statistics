const CACHE_NAME = 'baseball-player-card-pwa-v484-auto';
const CACHE_VERSION = 'v4.84';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.84',
  './dark-theme-overrides.css?v=v4.84',
  './diagnostic-runtime.js?v=v4.84',
  './live-static-update.js?v=v4.84',
  './cpbl-realtime.js?v=v4.84',
  './npb-realtime.js?v=v4.84',
  './postseason-history.css?v=v4.84',
  './js/module-loader.js?v=v4.84',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.84',
  './cpbl-cache-router.js?v=v4.84',
  './game-detail-enhancement.css?v=v4.84',
  './report-layout.css?v=v4.84',
  './landscape-state.css?v=v4.84',
  './game-detail-enhancement.js?v=v4.84',
  './report-layout.js?v=v4.84',
  './manifest.webmanifest?v=v4.84',
  './icon-192.png?v=v4.84',
  './icon-512.png?v=v4.84',
  './favicon-32.png?v=v4.84',
  './favicon-16.png?v=v4.84'
];
