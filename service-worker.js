const CACHE_NAME = 'baseball-player-card-pwa-v391-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v3.91',
  './diagnostic-runtime.js?v=v3.91',
  './live-static-update.js?v=v3.91',
  './cpbl-realtime.js?v=v3.91',
  './npb-realtime.js?v=v3.91',
  './postseason-history.css?v=v3.91',
  './js/module-loader.js?v=v3.91',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v3.91',
  './cpbl-cache-router.js?v=v3.91',
  './game-detail-enhancement.css?v=v3.91',
  './report-layout.css?v=v3.91',
  './landscape-state.css?v=v3.91',
  './game-detail-enhancement.js?v=v3.91',
  './report-layout.js?v=v3.91',
