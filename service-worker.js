const CACHE_NAME = 'baseball-player-card-pwa-v630-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v6.30',
  './dark-theme-overrides.css?v=v6.30',
  './diagnostic-runtime.js?v=v6.30',
  './live-static-update.js?v=v6.30',
  './cpbl-realtime.js?v=v6.30',
  './npb-realtime.js?v=v6.30',
  './postseason-history.css?v=v6.30',
  './js/module-loader.js?v=v6.30',
  MODULE_ORDER_URL,
  VERSIONED_MODULE_ORDER_URL,
  './postseason-history.js?v=v6.30',
  './cpbl-cache-router.js?v=v6.30',
  './game-detail-enhancement.css?v=v6.30',
  './report-layout.css?v=v6.30',
  './landscape-state.css?v=v6.30',
  './game-detail-enhancement.js?v=v6.30',
  './report-layout.js?v=v6.30',
  './manifest.webmanifest?v=v6.30',
  './icon-192.png?v=v6.30',
  './icon-512.png?v=v6.30',
  './favicon-32.png?v=v6.30',
  './favicon-16.png?v=v6.30'
];
