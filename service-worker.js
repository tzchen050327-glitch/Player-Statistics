const CACHE_NAME = 'baseball-player-card-pwa-v496-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v4.96',
  './dark-theme-overrides.css?v=v4.96',
  './diagnostic-runtime.js?v=v4.96',
  './live-static-update.js?v=v4.96',
  './cpbl-realtime.js?v=v4.96',
  './npb-realtime.js?v=v4.96',
  './postseason-history.css?v=v4.96',
  './js/module-loader.js?v=v4.96',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v4.96',
  './cpbl-cache-router.js?v=v4.96',
  './game-detail-enhancement.css?v=v4.96',
  './report-layout.css?v=v4.96',
  './landscape-state.css?v=v4.96',
  './game-detail-enhancement.js?v=v4.96',
  './report-layout.js?v=v4.96',
  './manifest.webmanifest?v=v4.96',
  './icon-192.png?v=v4.96',
  './icon-512.png?v=v4.96',
  './favicon-32.png?v=v4.96',
  './favicon-16.png?v=v4.96'
];
