const CACHE_NAME = 'baseball-player-card-pwa-v510-auto';
...
const APP_SHELL = [
  ...
  './diagnostics.html',
  './styles.css?v=v5.10',
  './dark-theme-overrides.css?v=v5.10',
  './diagnostic-runtime.js?v=v5.10',
  './live-static-update.js?v=v5.10',
  './cpbl-realtime.js?v=v5.10',
  './npb-realtime.js?v=v5.10',
  './postseason-history.css?v=v5.10',
  './js/module-loader.js?v=v5.10',
  MODULE_ORDER_URL,
  './postseason-history.js?v=v5.10',
  './cpbl-cache-router.js?v=v5.10',
  './game-detail-enhancement.css?v=v5.10',
  './report-layout.css?v=v5.10',
  './landscape-state.css?v=v5.10',
  './game-detail-enhancement.js?v=v5.10',
  './report-layout.js?v=v5.10',
  './manifest.webmanifest?v=v5.10',
  './icon-192.png?v=v5.10',
  './icon-512.png?v=v5.10',
  './favicon-32.png?v=v5.10',
  './favicon-16.png?v=v5.10'
];
