    ...
    const DEFAULT_HITTER_PHOTO_URL = './assets/default-hitter.jpg?v=v2.69';
    const DEFAULT_PITCHER_PHOTO_URL = './assets/default-pitcher.jpg?v=v2.69';
...
bg2: {
    ...
    function scheduleHomeGameDetailRefresh(detail) {
      ...
      if (activeHomeGameDetail.league === 'CPBL') {
        // v2.69: CPBL is pushed by Supabase Realtime. Poll only as a low-frequency
    ...
    async function setupAppUpdate() {
      ...
      try {
        ...
        // v2.69: do not check/apply updates merely because the user returned
