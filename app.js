    ...
    const DEFAULT_HITTER_PHOTO_URL = './assets/default-hitter.jpg?v=v2.55';
    const DEFAULT_PITCHER_PHOTO_URL = './assets/default-pitcher.jpg?v=v2.55';
...
bg2: {
    ...
    function scheduleHomeGameDetailRefresh(detail) {
      ...
      if (activeHomeGameDetail.league === 'CPBL') {
        // v2.55: CPBL is pushed by Supabase Realtime. Poll only as a low-frequency
