    ...
    const DEFAULT_HITTER_PHOTO_URL = './assets/default-hitter.jpg?v=v4.93';
    const DEFAULT_PITCHER_PHOTO_URL = './assets/default-pitcher.jpg?v=v4.93';
