(() => {
  ...
  // v2.65 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV265DomCompatibility() {
  ...
  ensureV265DomCompatibility();

  // v2.65 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV265';
