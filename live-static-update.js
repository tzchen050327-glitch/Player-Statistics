(() => {
  ...
  // v2.69 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV269DomCompatibility() {
  ...
  ensureV269DomCompatibility();

  // v2.69 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV269';
