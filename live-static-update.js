(() => {
  ...
  // v2.56 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV256DomCompatibility() {
  ...
  ensureV256DomCompatibility();

  // v2.56 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV256';
