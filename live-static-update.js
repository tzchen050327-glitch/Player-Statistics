(() => {
  ...
  // v2.60 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV260DomCompatibility() {
  ...
  ensureV260DomCompatibility();

  // v2.60 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV260';
