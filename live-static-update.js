(() => {
  ...
  // v2.70 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV270DomCompatibility() {
  ...
  ensureV270DomCompatibility();

  // v2.70 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV270';
