(() => {
  ...
  // v2.59 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV259DomCompatibility() {
  ...
  ensureV259DomCompatibility();

  // v2.59 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV259';
