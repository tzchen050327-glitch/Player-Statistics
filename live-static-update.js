(() => {
  ...
  // v2.64 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV264DomCompatibility() {
  ...
  ensureV264DomCompatibility();

  // v2.64 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV264';
