(() => {
  ...
  // v2.52 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV252DomCompatibility() {
  ...
  ensureV252DomCompatibility();

  // v2.52 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV252';
