(() => {
  ...
  // v2.55 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV255DomCompatibility() {
  ...
  ensureV255DomCompatibility();

  // v2.55 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV255';
