(() => {
  ...
  // v2.61 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV261DomCompatibility() {
  ...
  ensureV261DomCompatibility();

  // v2.61 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV261';
