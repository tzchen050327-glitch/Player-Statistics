(() => {
  ...
  // v2.63 index.html and app.js drifted apart: the current HTML removed several
  ...
  function ensureV263DomCompatibility() {
  ...
  ensureV263DomCompatibility();

  // v2.63 emergency mode: unregister old workers and return a harmless fake
  ...
  const BOOT_RECOVERY_KEY = 'baseballBootRecoveryV263';
